...
const SHUFFLE_STEP_MS = 72
const SHUFFLE_SPIN_MS = 105
const FINAL_SPIN_MS = 620
const SHUFFLE_EASING = 'cubic-bezier(0.22, 1, 0.36, 1)'
  ...
  return (
    <div>
      <NumberFlow
        ...
        className={`hero-stat-number${isAnimating ? ' is-animating' : ''}`}
        onAnimationsFinish={() => {
        ...
        opacityTiming={{ duration: 130, easing: 'ease-out' }}
        plugins={[continuous]}
        prefix={prefix}
        spinTiming={{
